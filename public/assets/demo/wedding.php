...
<!-- Mirrored from kamleshyadav.com/html/astrology/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Feb 2021 09:23:27 GMT -->
<head>
<title>Wedding :: eWorkship</title>
<meta charset="utf-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="ast_logo">
					<a href="index.html"><img src="images/eworship.png" width="110px" height="auto" alt="Logo" title="Logo"></a>
				...
				<div class="ast_main_menu_wrapper">
					<div class="ast_menu">
						<ul>
							...
							<li><a href="horescope.php">horoscope</a></li>
							...
							<ul class="submenu">
										...
										<!--	<li><a href="south_states_temples.html">Temples Choice of Clients in Southern States </a></li>-->
										</ul>
							</li>
							<li><a href="homam_parikkaram.php">Homam and Parikarm</a>
						<!--	<ul class="submenu">
											<li><a href="homam_parikaram_by_astrologer.html">Suggest by Astrologer</a></li>
											<li><a href="homam_parikaram_preferred.html">Homam and Pariharam Preferred by Clients from our Portal List of Homam and Pariharam</a></li>
											<li><a href="homam_parikaram_client_choice.html">Clients choice</a></li>
							...
							<!--<li><a href="appointment.html">Solutions</a></li>-->
...
$message .= '<p style="color:#080;font-size:18px;">Name of Groom : '.$_POST['name_of_groom'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Name of Bride: '.$_POST['name_of_bride'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Age of Groom: '.$_POST['groom_age'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Age of Bride: '.$_POST['bride_age'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Birthstar of Groom: '.$_POST['groom_birthstar'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Birthstar of Bride: '.$_POST['bride_birthstar'].'</p>';
...
$message .= '<p style="color:#080;font-size:18px;">Aadhar Of Groom: '.$_POST['groom_aadhar'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Aadhar Of Bride: '.$_POST['bride_aadhar'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Preffered Date : '.$_POST['preffered_date'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Preffered Time : '.$_POST['preffered_time'].'</p>';
...
?>
					<form>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" placeholder="Name Of Groom" id="name_of_groom" type="text" name="name_of_groom" data-constraints="@Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>name of bride</label>
							<input type="text" placeholder="Name Of Bride" id="name_of_bride" type="text" name="name_of_bride" data-constraints="@Required" required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>groom's age</label>
							<input type="date" placeholder="Groom's Age" id="groom_age" name="groom_age"  data-constraints="@dob @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>bride's age</label>
							<input type="date" placeholder="Bride's Age" id="bride_age" name="bride_age"  data-constraints="@dob @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>Groom's Birth Star</label>
							<select name="groom_birthstar" id="groom_birthstar">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>Bride's Birth Star</label>
							<select name="bride_birthstar" id="bride_birthstar">
							<option value="">Select</option>
								<option value="Ashwini">Ashwini</option>
								<option value="Bharani">Bharani</option>
								<option value="Krittika">Krittika</option>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="phone" placeholder="Contact Number" id="phone" name="phone" data-constraints="@Number @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Email</label>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Aadhar card / ID of Groom</label>
							<input type="text" placeholder="Groom's Aadhar Number" id="groom_aadhar" name="groom_aadhar"  data-constraints="@Aadhar @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Aadhar card / ID Of Bride</label>
							<input type="text" placeholder="Bride's Aadhar Number" id="bride_aadhar" name="bride_aadhar"  data-constraints="@Aadhar @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>Preferred  Date</label>
							<input type="date" id="preffered_date" name="preffered_date" placeholder="Preferred  Date" data-constraints="@Preferred  Date @Required"  required>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label>Preferred Time</label>
							<input type="time" id="preffered_time" name="preffered_time" placeholder="Preferred  Time" data-constraints="@Preferred Time @Required"  required>
						</div>
						
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Upload Groom's Birth Chart</label>
							<input type="file" id="myFile" name="filename" style="border: none;">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Upload Bride's Birth Chart</label>
							<input type="file" id="myFile" name="filename" style="border: none;">
						</div>
						...
						<h4><strong>Note: Please Note our Account details - A/c No. 123456789, IFSC:20056789,Abc branch,Tamilnadu</strong></h4>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="container">
		<div class="row">
			...
			<div class="ast_footer_info">
				<img src="images/eworship.png" width="110px" height="auto" alt="Logo">	
				<ul>
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
				<div class="widget text-widget">
					...
					<div class="ast_servicelink">
						<ul>
							<li><a href="archana.html">Archana</a></li>
											<li><a href="parikaram_homam.html">Parikaram & Homam</a></li>
											<li><a href="vasthu.html">VASTHU</a></li>
