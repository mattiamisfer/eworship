...
<head>
<title>Services :: eWorkship</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-1 col-xs-offset-0">
				<div class="ast_heading">
					<h1>Parikaram &   <span>Homam for</span></h1>
			...
			<div class="ast_whywe_info">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="ast_whywe_info_box">
						...
						<div class="ast_whywe_info_box_info">
							<p>Special Services for NRI's </p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				...
				<div class="owl-carousel owl-theme">
					<div class="item">
						<div class="ast_service_box">
							...
							<h4>Marriage</h4>
							<p>60’th year, 70’th year and 80’th year Kalyanam/ h year and 80’th year Kalyanam/ Marriage delay</p>
					...
					<div class="item">
						<div class="ast_service_box">
							...
							<h4>Education</h4>
							<p>Overseas Education/ Low average study issues/ Career advise</p>
							<div class="clearfix"></div>
							<a href="service_single.html" class="ast_btn">read more</a>
						</div>
					</div>
					<div class="item">
						<div class="ast_service_box">
							...
							<h4>Family dispute</h4>
							<p>To solve Difference between Husband & wife dispute</p>
							<div class="clearfix"></div>
							<a href="service_single.html" class="ast_btn">read more</a>
						</div>
					</div>
					<div class="item">
						<div class="ast_service_box">
							...
							<h4>Family Issues</h4>
							<p>To resolve family members issues etween father, mother, daughter, son etc.</p>
							<div class="clearfix"></div>
							<a href="service_single.html" class="ast_btn">read more</a>
						</div>
					</div>
					...
					<div class="item">
						<div class="ast_service_box">
							...
							<h4>get a child / safety birth</h4>
