...
<head>
<title>Request Offering :: eWorkship</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="ast_journal_info">
					<h3>make your offering</h3>
					<p>eWorship.in – the apt platform to perform your religious rituals with utmost satisfaction.</p>
					<p> Attain divine blessings for you and your family through eWorship.</p>
...
$message .= '<p style="color:#080;font-size:18px;">Archana Selected : '.$_POST['archana'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Preffered Time Of Day : '.$_POST['time_of_day'].'</p>';
$message .= '<p style="color:#080;font-size:18px;">Way to reach : '.$_POST['way_to_reach'].'</p>';
...
?>
					<form>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							<label>Address</label>
							<input type="text" placeholder="Address" id="address" name="address"  data-constraints="@Address @Required"  required>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label>Archanas</label>
							<select name="archana" id="archana">
							<option value="">Select</option>
								<option value="1">Navagraha Pooja </option>
								<option value="2">Pushanjali</option>
							</select>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label>Remarks</label>
							<textarea placeholder="Message" rows="4" id="message" name="message" data-constraints="@Required" required></textarea>
						</div>
