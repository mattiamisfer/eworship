...
<head>
<title>Rituals for Ancestors :: eWorkship</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="ast_autho_wrapper">
					...
					<!--ritual submitting form-->
					<div id="login-dialog1" class="zoom-anim-dialog mfp-hide">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<ul class="breadcrumb">
					...
					<li>//</li>
					<li><a href="archana.html">Rituals for Ancestors</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="ast_service_wrapper ast_toppadder70 ast_bottompadder50">
	...
	<h2 style="text-align:center;">IMPORTANT RITUALS</h2>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="ast_service_box">
					...
					<a href="#login-dialog1" class="popup-with-zoom-anim ast_btn">Request Offering</a>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="ast_service_box">
					...
					<div class="clearfix"></div>
					<a href="#login-dialog" class="popup-with-zoom-anim ast_btn">Request Offering</a>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="ast_service_box">
